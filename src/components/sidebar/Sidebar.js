    ...
    <ProSidebar>
      ...
      <SidebarContent>
        <Menu iconShape="circle">
          ...
          <MenuItem onClick={() =>setSection('member') }>Member &amp; Coach</MenuItem>
          <MenuItem onClick={() =>setSection('calendar') }>Course Management</MenuItem>
          <MenuItem onClick={() =>setSection('performance') }>Performance Management</MenuItem>
        </Menu>
        {/* <Menu iconShape="circle">
          <SubMenu
